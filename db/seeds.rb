...
Comment.create(commenter_id: 1, commentee_id: 3, content: "hey whatsup this is cool")
Comment.create(commenter_id: 1, commentee_id: 2, content: "hey whats bool")
Comment.create(commenter_id: 2, commentee_id: 1, content: "whatsool")
Comment.create(commenter_id: 1, commentee_id: 1, content: "hebool")