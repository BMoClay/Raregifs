...
User.create(name: "Ben Morgan-Cleveland", password: "123", email: "email")
...
User.create(name: "Morgan", password: "123", email: "email")
...
Acquisition.create(user_id: 1, artwork_id: 2)
