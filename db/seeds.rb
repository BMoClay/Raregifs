...
Artwork.create(user_id: 1, title: "Anger", image:"https://media3.giphy.com/media/84rG9j2H62hwc/giphy.gif")
...
Acquisition.create(user_id: 1, artwork_id: 3)
Acquisition.create(user_id: 1, artwork_id: 4)
